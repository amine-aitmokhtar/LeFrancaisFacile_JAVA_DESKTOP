 ...
 */
public class AidePrincipale extends javax.swing.JFrame {

    /**
     * Creates new form Principale
     */
    public AidePrincipale() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AidePrincipale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AidePrincipale().setVisible(true);
            }
        });
    }
