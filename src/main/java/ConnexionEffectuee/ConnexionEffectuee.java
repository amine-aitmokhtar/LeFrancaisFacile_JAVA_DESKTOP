 ...
 */
public class ConnexionEffectuee extends javax.swing.JFrame {

    /**
     * Creates new form Principale
     */
    public ConnexionEffectuee() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConnexionEffectuee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConnexionEffectuee().setVisible(true);
            }
        });
    }
